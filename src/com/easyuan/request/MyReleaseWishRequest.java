/**   
 * Filename:    MyReleaseWishRequest.java   
 * Copyright:   Copyright (c)2013  
 * Company:     easyuan 
 * @version:    1.0   
 * @since:      JDK 1.7.0 
 * Create at:   2013-5-4 下午8:03:22   
 * Description:  
 *   
 ...
 * 2013-5-4 null        1.0         1.0 Version 
 */
public class MyReleaseWishRequest extends WishListRequest {

	private String modifiedTime;
	
	public MyReleaseWishRequest(Context context, int count, String url, String time) {
